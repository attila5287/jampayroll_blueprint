...
class PayStub(Employee_form_data):
    ...
    def dict_for_perc(self):
        pass
        ''' to implement progress bars and display the percentage of cut on paystub, still beta '''
        dict = {
...
class P4y_stub(Employee_form_data):
